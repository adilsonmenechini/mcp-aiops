...
from utils.ai_prompts import make_system_prompt, make_main_prompt, make_sre_prompt
...
# ------------------------------------------------------------------ SideBar widgets
    ...
    st.session_state['selected_prompt_type'] = st.selectbox(
...
# ------------------------------------------------------------------ handle question (if any text)
    if user_text:
        ...
        with st.spinner("Thinking…", show_time=True):
            if st.session_state.get('selected_prompt_type') == "SRE":
                from utils.ai_prompts import make_sre_prompt
                system_prompt = make_sre_prompt()
            else:
